...
8) per la registrazione si dovrebbero usare i form autovalidanti di html5, ad esempio l'email non ti avvisa se non corrisponde al pattern, e quando ti vai a registrare la chiamata non funziona (vai gianlu)
